<template>
  <div id="stockin">
    ...
    <div class="main">
      <main>
        <h1 class="title">Detail Transaksi Penjualan</h1>
...
export default {
  ...
  components: { NavbarJual, FooterMenu, LoadIng },
  data() {
    return {
      transaction: {},
      isLoading: true,
  ...
  methods: {
    fetchTransactionDetails() {
      ...
      axios
        .get(
          `${process.env.VUE_APP_API_URL}/outtransaction/detailPenjualan?idTransaksi=${this.idTransaksi}`,
          {
            headers: {
